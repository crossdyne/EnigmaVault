...
using MediatR;
using EncryptedData = EnigmaVault.Secret.Service.Domain.ValueObjects.Password.EncryptedData;

namespace EnigmaVault.Secret.Service.Application.Features.VaultItems.Commands.Update
{
