using EnigmaVault.Secret.Service.Application.Features.Folders.Commands.CreateRoot;
using EnigmaVault.Secret.Service.Application.Features.Folders.Commands.CreateSubFolder;
using EnigmaVault.Secret.Service.Application.Features.Folders.Commands.Delete;
using EnigmaVault.Secret.Service.Application.Features.Folders.Commands.Update;
using EnigmaVault.Secret.Service.Application.Features.Folders.Queries.GetAll;
...
namespace EnigmaVault.Secret.Service.Api.Controllers
{
    [ApiController]
    [Route("api/folders")]
